...
| <a name="input_private_subnets_name_override"></a> [private\_subnets\_name\_override](#input\_private\_subnets\_name\_override) | Private Subnets name. If left undefined, this will use the naming convention of<br>`namespace-environment-private-subnet`. | `string` | `null` | no |
| <a name="input_public_subnets_name_override"></a> [public\_subnets\_name\_override](#input\_public\_subnets\_name\_override) | Public Subnets name. If left undefined, this will use the naming convention of<br>`namespace-environment-public-subnet`. | `string` | `null` | no |
