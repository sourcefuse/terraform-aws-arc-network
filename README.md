...
| <a name="input_vpn_self_service_portal_enabled"></a> [vpn\_self\_service\_portal\_enabled](#input\_vpn\_self\_service\_portal\_enabled) | Specify whether to enable the self-service portal for the Client VPN endpoint | `bool` | `false` | no |
